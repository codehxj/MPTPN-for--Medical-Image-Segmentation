...
class LViT(nn.Module):
    def __init__(self, config, n_channels=3, n_classes=1, img_size=224, vis=False):
        ...
        self.outc = nn.Conv2d(in_channels * 9, n_classes, kernel_size=(1, 1), stride=(1, 1))    #!!!!!!in_channels * 9
        ...
        self.patchMerging1_4 = PatchMerging(input_resolution=(56,56), dim=256) #[2,256,56,56]->[2,512,28,28]
        ...
        self.patchMerging2_4 = PatchMerging(input_resolution=(56,56), dim=256) #[2,256,56,56]->[2,512,28,28]
        ...
        self.patchMerging3_4 = PatchMerging(input_resolution=(56,56), dim=256) #[2,256,56,56]->[2,512,28,28]
        self.patchExpand4_3 = PatchExpand(input_resolution=(28,28), dim=512) #[2,512,28,28]->[2,256,56,56]
        self.patchExpand4_2 = PatchExpand(input_resolution=(56,56), dim=256) #[2,256,56,56]->[2,128,112,112]
        self.patchExpand4_1 = PatchExpand(input_resolution=(112,112), dim=128) #[2,128,112,112]->[2,64,224,224]
        self.patchExpand21 = PatchExpand(input_resolution=(112,112), dim=384) #[2,384,112,112]->[2,192,224,224]
        self.patchExpand32 = PatchExpand(input_resolution=(56,56), dim=768)  #[2,768,56,56]->[2,384,112,112]
        self.patchExpand31 = PatchExpand(input_resolution=(112,112), dim=384) #[2,384,112,112]->[2,192,224,224]
        #self.patchExpand = PatchExpand(input_resolution=(112,112), dim=576)
    ...
    def forward(self, x, text):
        ...
        #x4 = self.down3(x3) #[2,512,28,28]
        #y4 = self.downVit3(x4, y3, text4) #[2,196,512]
        #x5 = self.down4(x4) #[2,512,14,14]
        #y4 = self.upVit3(y4, y4, text4, True) #[2,196,512]
        ...
        #x4 = self.reconstruct4(y4) + x4  #[2,512,28,28]
        x1_2 = self.patchMerging1_2(x1)
        x1_3 = self.patchMerging1_3(x1_2)
        #x1_4 = self.patchMerging1_4(x1_3)
        x2_1 = self.patchExpand2_1(x2)
        x2_3 = self.patchMerging2_3(x2)
        #x2_4 = self.patchMerging2_4(x2_3)
        x3_2 = self.patchExpand3_2(x3)
        x3_1 = self.patchExpand3_1(x3_2)
        #x3_4 = self.patchMerging3_4(x3)
        #x4_3 = self.patchExpand4_3(x4)
        #x4_2 = self.patchExpand4_2(x4_3)
        #x4_1 = self.patchExpand4_1(x4_2)
        #x1 = torch.cat([x1,x1_2,x1_3,x1_4], dim=1) #[8,64,224,224]
        #x2 = torch.cat([x2_1,x2,x2_3,x2_4], dim=1) #[8,128,112,112]
        #x3 = torch.cat([x3_1,x3_2,x3,x3_4], dim=1) #[8,256,56,56]
        #x4 = torch.cat([x4_1,x4_2,x4_3,x4], dim=1) #[8,512,28,28]
        ...
        #x4 = self.patchExpand4_3(x4)
        #x4 = self.patchExpand4_2(x4)
        #x4 = self.patchExpand4_1(x4)
        x = torch.cat([x1,x2,x3], dim=1) #[2,576,224,224] !!!!!![1,576,112,112]

        #x = self.up4(x5, x4) #[2, 256, 28, 28]
        #x = self.up3(x, x3)  #[2, 128, 56, 56]
        #x = self.up2(x, x2)  #[2, 64, 112, 112]
        #x = self.up1(x, x1)  #[2, 64, 224, 224]
